        ...
        <form action="{{ route('players.update', $player) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="first_name"
                    ...
                    required placeholder="First Name" value="{{ old('first_name', $player->first_name) }}">
                ...
                <input type="text" name="last_name"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Last Name" value="{{ old('last_name', $player->last_name) }}">
                ...
                <input type="text" name="position"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Position" value="{{ old('position', $player->position) }}">
                ...
                <input type="text" name="age"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Age" value="{{ old('age', $player->age) }}">
                ...
                <input type="date" name="dob"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="DoB" value="{{ old('dob', $player->dob) }}">
                ...
                <input type="text" name="height"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Height" value="{{ old('height', $player->height) }}">
                ...
                <input type="text" name="weight"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Weight" value="{{ old('weight', $player->weight) }}">
                ...
                <input type="text" name="nationality"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Nationality" value="{{ old('nationality', $player->nationality) }}">
                ...
                <input type="text" name="passport"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="Passport" value="{{ old('passport', $player->passport) }}">
            ...
            <div class="mb-4">
                ...
                <img src="{{ $player->image }}" alt="" class="mb-4 md:w-2/5 sm:auto">
